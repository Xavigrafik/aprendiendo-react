        ...
        <div className="container">
            <div className="row py-5">
                ...
                <div className="col-12 col-md p-3 mb-3">
                    ...
                    <div className="border p-2 mb-2 text-md-teal PEPE-a PEPE-sm-b PEPE-md-a PEPE-lg-b PEPE-xl-a PEPE-xxl-b"> text-md-teal PEPE-a PEPE-sm-b PEPE-md-a PEPE-lg-b PEPE-xl-a PEPE-xxl-b</div>
